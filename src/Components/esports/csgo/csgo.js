...
import csgoTeam from './CSGORoster.js';
  ...
  return (
    <div className="csgo-container">
      <section id="about" className="about-section">
        <h1>CSGO Esports</h1>
        <p>Welcome to the Falcons CSGO esports page!</p>
        <p>
          The Falcons CSGO team is dedicated to competing at the highest level in the esports scene.
      ...
      <section id="schedule" className="schedule-section">
        ...
        <div className="match-card">
          <a href="https://liquipedia.net/counterstrike/Team_Falcons/Matches" target="_blank" rel="noopener noreferrer">
            <h3>Intel Extreme Masters Dallas 2025 vs Vitality</h3>
          </a>
      ...
      <section id="team" className="team-section">
        ...
        <div className="team-roster">
          {Object.entries(csgoTeam).map(([key, player]) => (
