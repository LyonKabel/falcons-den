...
import ApexTeam from './ApexRoster.js';
  ...
  return (
    <div className="apex-container">
      ...
      <section id="about" className="about-section">
        ...
        <p>Welcome to the Falcons Apex Legends esports page!</p>
        <p>
          The Falcons Apex Legends team is dedicated to competing at the highest level in the esports scene.
      ...
      <section id="team" className="team-section">
        ...
        <div className="team-roster">
          {Object.entries(ApexTeam).map(([key, player]) => (
      ...
      <section id="email" className="email-section"></section>
