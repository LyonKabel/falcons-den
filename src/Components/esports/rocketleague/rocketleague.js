...
import OverwatchTeam from './OverwatchRoster.js';
  ...
  return (
    <div className="Overwatch-container">
      <section id="about" className="about-section">
        ...
        <p>Welcome to the Falcons Overwatch esports page!</p>
        <p>
          The Falcons Overwatch team is dedicated to competing at the highest level in the esports scene.
      ...
      <section id="team" className="team-section">
        ...
        <div className="team-roster">
          {Object.entries(OverwatchTeam).map(([key, player]) => (
